            ...
            <div className="login-actions">
              {mfaToken ? (
                ...
                <>
                  ...
                  <div className="google-login-official" style={{ width: googleButtonWidth }}>
                    {GOOGLE_CLIENT_ID_CONFIGURED ? (
                      <div className="google-login-custom">
                        <div className="google-login-custom-face" aria-hidden="true">
                          <span className="google-login-custom-icon">
                          ...
                          <span className="google-login-custom-text">Sign in with Google</span>
                        </div>
                        <GoogleLogin
